        ...
        <section id="project" className="bg-white dark:bg-gray-900 pt-10 border-box overflow-hidden">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                    <h2 data-aos="fade-up"
                        className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white" suppressHydrationWarning>My Project
                    </h2>
                    <p data-aos="fade-up" data-aos-delay="100"
                        className="font-light text-gray-500 sm:text-xl dark:text-gray-400" suppressHydrationWarning>These are some examples of
