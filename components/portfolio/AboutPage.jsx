    ...
    return (
        <section id="about" className="pt-0 -mt-10 mb-0 bg-white px-4 py-8 antialiased dark:bg-gray-900 lg:py-16 border-box overflow-hidden">
            ...
            <div
                ...
                <ImageAbout suppressHydrationWarning />

                <div className="me-auto place-self-center lg:col-span-7 lg:mt-0" suppressHydrationWarning>
                    <h1 data-aos="fade-left"
                        className="mb-3 text-2xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white md:text-4xl" suppressHydrationWarning>
                        About Me
                    </h1>
                    <LazyText text={"Hello! I’m Aji Setiawan, a Information Technology and student at Bina Sarana Informatika University. I have a strong passion for software development, particularly in web development, database management, and programming with Python, Java, and JavaScript. With a commitment to continuous learning and improvement. I strive to deliver effective and innovative technology solutions in every project i undertake."} suppressHydrationWarning />
                    <Link data-aos-delay="200" data-aos="zoom-in"
                        ...
                        target="_blank" suppressHydrationWarning>
