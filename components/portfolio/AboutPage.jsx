        ...
        <section id="about" className="pt-0 -mt-10 mb-0 bg-white px-4 py-8 antialiased dark:bg-gray-900 lg:py-16 border-box overflow-hidden">
            <div
                ...
                <div data-aos="fade-up-right" className="lg:py-[50px] lg:px-[80px] lg:col-span-5 lg:mt-0 hidden lg:block">
                    <a className="" href="#">
                        <HeroImage url="/images/AboutImage.png" alt="Aji Setiawan" />
                    </a>
                </div>
                <div className="me-auto place-self-center lg:col-span-7 lg:mt-0">
                    ...
                    <p className="mb-6 text-gray-500 dark:text-gray-400">Hello!
                        I’m Aji Setiawan, a Information Technology and student at Bina Sarana Informatika University. I
                        have
                        a strong passion for software development, particularly in web development, database management,
                        and programming with Python, Java, and JavaScript. With a commitment to continuous learning and
                        improvement. I strive to deliver effective and innovative technology solutions in every
