        ...
        <section id="home" className="pt-10 bg-white dark:bg-gray-900 box-border">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 box-border">
                ...
                <div className="mr-auto place-self-center lg:col-span-7">
                    <h1 className="mb-3 text-xl md:text-2xl lg:text-3xl xl:text-4xl dark:text-white" data-aos="fade-right" data-aos-delay="100" suppressHydrationWarning >
                    ...
                    <HeadingType suppressHydrationWarning />
                    ...
                    <Link href="#contact" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900" data-aos-delay="300" data-aos="zoom-in" suppressHydrationWarning >
                    ...
                    <Link href="https://www.linkedin.com/in/ajiisetiawan/" data-aos-delay="400" data-aos="zoom-in" className="mt-3 inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800" target="_blank" suppressHydrationWarning  >
                        <svg className="mr-1 w-6 h-6 text-base dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
