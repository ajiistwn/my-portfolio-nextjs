    ...
    return (
        <div id="about-sm" className="relative mb-0 lg:mt-0 lg:col-span-5 lg:flex box-border overflow-hidden ">
            ...
            <span className="-ms-[400px] md:-ml-[300px] box-border ">
                <svg className="bg-pimary-700 -ml-[50px] w-[120%] z-0 absolute -bottom-10 md:w-[120%] md:-ml-[100px] md:-bottom-24 lg:-ml-[150px] lg:-bottom-16 xl:-ml-[300px]" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" {...(isClient && { "data-aos": "fade-left" })}>
